...
Proof.
  ...
  - apply Axiom_Extent; split; intros; try apply Theorem19; Ens.
    ...
    { split; try unfold Subclass; auto.
      apply Lemma35; exists dom(f); apply Axiom_Scheme.
...
Proof.
  ...
  assert (\{ λ z, x ≈ z /\ Ordinal z \} ⊂ \{ λ z, x ≈ z /\ Ordinal z \}
            /\ \{ λ z, x ≈ z /\ Ordinal z \} ≠ Φ).
  { split; try unfold Subclass; auto.
    apply Lemma35; exists ran(f); apply Axiom_Scheme; split; auto. }
  ...
  - apply Axiom_Extent; split; intros.
    ...
    + apply Axiom_Scheme; split; Ens.
      ...
      * assert (g[z] ∈ ran(g)).
        ...
        { apply Theorem32; apply Axiom_Scheme; split; Ens. 
          apply Theorem33 with (x:=x); auto.
...
Proof.
  ...
  rewrite H2; unfold Difference; apply Theorem4'.
  ...
  assert (Φ ∈ μ).
  { apply Theorem19; generalize Axiom_Infinity; intros.
  ...
  { unfold Equivalent; exists \{\ λ u v, u∈x /\ v = [u] \}\.
    ...
    - apply Axiom_Extent; split; intros.
      ...
      + unfold Domain; apply Axiom_Scheme; split; Ens; exists [z].
        AssE z; apply Theorem42 in H1; apply Axiom_SchemeP.
        repeat split; try apply Theorem49; Ens.
    - apply Axiom_Extent; split; intros.
...
Proof.
  ...
  - destruct H5; unfold Restriction in H5, H6.
    ...
    + unfold Difference in H8, H9; apply Theorem4' in H8.
      apply Theorem4' in H9; destruct H8, H9; clear H10 H11.
      unfold Function in H1; apply H1 with (x:= x0); auto.
    + destruct H9.
      * unfold Difference in H8; apply Theorem4' in H8; destruct H8.
    ...
    + destruct H8.
      * unfold Difference in H9; apply Theorem4' in H9; destruct H9.
  ...
  - destruct H5; unfold Inverse, Restriction in H5, H6.
    ...
    + unfold Difference in H11, H12; apply Theorem4' in H11.
    ...
    + destruct H12.
      * unfold Difference in H11; apply Theorem4' in H11; destruct H11.
    ...
    + destruct H11.
      * unfold Difference in H12; apply Theorem4' in H12; destruct H12.
  ...
  - apply Axiom_Extent; split; intros.
    ...
    + unfold Domain; apply Axiom_Scheme; split; Ens.
      ...
      * assert (z ∈ dom(f)). { rewrite H2; apply Theorem4; tauto. }
        ...
        { left; unfold Difference; apply Theorem4'; split; auto.
  ...
  - apply Axiom_Extent; split; intros.
    ...
    + unfold Range; apply Axiom_Scheme; split; Ens.
      ...
      * unfold Range in H6; apply Axiom_Scheme in H6; destruct H6, H8.
        exists x0; AssE [x0,z]; unfold Restriction; apply Theorem4'; split.
        { unfold En_g'; apply Axiom_SchemeP; split; auto; left.
          unfold Difference; apply Theorem4'; split; auto; unfold Complement.
...
Proof.
  ...
  - unfold Connect; intros; destruct H4; rewrite <- H1 in H4, H5.
    ...
    + left; unfold Rrelation; apply Axiom_SchemeP;split;try apply Theorem49;Ens.
...
Proof.
  ...
  - double H; unfold Finite in H; apply Property_Finite in H0.
    unfold W in H; apply Axiom_Scheme in H; destruct H.
    unfold NInteger in H1; destruct H1; apply Theorem107 in H1.
    ...
    + assert (W ⊂ ran(f)).
      ...
      { split; unfold Subclass; intros.
        ...
        - assert (Φ ∈ W); try apply Theorem135; auto; double H11.
          ...
          apply Theorem49 in H13; destruct H13; apply Lemma35.
...
Proof.
  ...
  - unfold WellOrdered; split; intros.
    + unfold Connect; intros; destruct H0; unfold Singleton in H0, H1.
      ...
      double H; apply Theorem19 in H; apply Theorem19 in H4.
    ...
    + clear H1 H2; unfold Connect in H, H0; unfold Connect; intros.
      ...
      * clear H0; generalize (classic (u ∈ x)); intros; destruct H0.
        { assert (u ∈ x /\ v ∈ x); auto; apply H in H3.
          ...
          - right; left; SplitEnsP. }
        { right; left; SplitEnsP.
          right; right; split; auto; unfold Difference; apply Theorem4'.
          split; auto; unfold Complement; SplitEns. }
    ...
    + clear H H0; unfold WellOrdered in H1, H2.
      ...
      * assert (\{λ z, z∈y0 /\ z∈(y~x)\} ⊂ y).
        { unfold Subclass; intros; apply Axiom_Scheme in H4; destruct H4, H5.
          unfold Difference in H6; apply Theorem4' in H6; apply H6. }
        add (\{λ z, z∈y0 /\ z∈(y~x)\} <> Φ) H4; apply H2 in H4; clear H0 H2.
        destruct H4 as [z H0]; exists z; unfold FirstMember in H0.
        destruct H0; apply Axiom_Scheme in H0; destruct H0, H4.
        unfold Difference in H5; apply Theorem4' in H5; destruct H5.
...
Proof.
  ...
  - generalize (classic (z ∈ [x])); intros; destruct H1.
    ...
    + apply Theorem4; left; unfold Difference; apply Theorem4'.
      split; auto; unfold Complement; apply Axiom_Scheme; Ens.
  - apply Theorem4 in H0; destruct H0.
    + unfold Difference in H0; apply Theorem4' in H0; apply H0.
...
Proof.
  ...
  - apply Axiom_Scheme in H; destruct H, H0, H0.
    ...
    + apply Theorem4; left; apply Axiom_Scheme; Ens.
...
Proof.
  ...
  { apply Theorem137.
    ...
    - apply Axiom_Scheme; generalize (Theorem135 x); intros; destruct H2.
    ...
    - intros; apply Axiom_Scheme in H2; apply Axiom_Scheme.
      ...
      + apply H4; assert (Ensemble (y ~ [f[u]])).
        { apply (Theorem33 y _); auto; unfold Subclass; intros.
            ...
            - apply Axiom_Extent; split; intros.
              + unfold Range in H13; apply Axiom_Scheme in H13.
                ...
                * clear H17; apply Property_Value in H15; auto.
                  ...
                  clear H15; unfold Difference; apply Theorem4'; double H14.
                  ...
                  split; apply Axiom_SchemeP; split; try apply Theorem49; auto.
                * unfold Complement in H16; apply Axiom_Scheme in H16.
                  destruct H16; contradiction.
              + unfold Difference in H13; apply Theorem4' in H13; destruct H13.
        ...
        * unfold Difference in H14; apply Theorem4' in H14; destruct H14.
          apply H8; auto.
      + assert (f[u] ∈ y).
        { assert (u ∈ dom(f)).
          { rewrite H10, H6; apply Theorem4; right; apply Axiom_Scheme; Ens. }
  ...
  - assert (∪ \{ λ u, exists v, v∈x /\ u = ([v] × y) \} = x × y).
    { clear H1; apply Axiom_Extent; split; intros.
      - unfold Element_U in H1; apply Axiom_Scheme in H1; destruct H1, H2, H2.
        ...
        rewrite H9; try apply Theorem19; Ens.
      - unfold Cartesian in H1; PP H1 a b; apply Axiom_SchemeP in H2.
        ...
        + unfold Cartesian; apply Axiom_SchemeP; repeat split; auto.
          unfold Singleton; apply Axiom_Scheme; split; Ens.
        + apply Axiom_Scheme; split; Ens; apply Theorem73; split; Ens.
    ...
    + assert (x ≈ \{ λ u, exists v, v∈x /\ u = ([v] × y) \}).
      { unfold Equivalent; exists (\{\ λ u v, u∈x /\ v = ([u] × y) \}\).
        ...
        - apply Axiom_Extent; split; intros.
          ...
          + apply Axiom_Scheme in H2; destruct H2, H3, H3.
            ...
            apply Axiom_SchemeP; repeat split; try apply Theorem49; Ens. }
      ...
      { apply Property_Finite in H; apply Property_Finite in H0; split; auto.
        ...
        apply (Theorem33 pow(x × y) _); auto; unfold Subclass; intros.
...
Proof.
  ...
  - generalize (classic (y ∈ z)); intros; destruct H2.
    ...
    + left; apply Axiom_Scheme; split; auto; unfold Subclass; intros; double H3.
      unfold Difference; apply Theorem4'; apply H1 in H4; split; auto.
      unfold Complement; apply Axiom_Scheme; split; Ens; intro.
...
Proof.
  ...
  { apply Theorem137.
    ...
    - apply Axiom_Scheme; generalize (Theorem135 x); intros; destruct H1.
    ...
    - intros; apply Axiom_Scheme in H1; apply Axiom_Scheme.
      ...
      { apply H3; assert (Ensemble (y ~ [f[u]])).
        { apply (Theorem33 y _); auto; unfold Subclass; intros.
          unfold Difference in H12; apply Theorem4' in H12; apply H12. }
          ...
          - apply Axiom_Extent; split; intros.
            + unfold Range in H12; apply Axiom_Scheme in H12; destruct H12, H13.
              ...
              * clear H16; apply Property_Value in H14; auto.
                ...
                clear H14; unfold Difference; apply Theorem4'; double H13.
      ...
      { unfold Equivalent.
        ...
        - destruct H13; apply Axiom_SchemeP in H13; apply Axiom_SchemeP in H14.
          ...
          + assert (z0 ∈ (y0 ∪ [f[u]])). { apply Theorem4; tauto. }
            ...
            apply H14 in H18; unfold Difference in H18; apply Theorem4' in H18.
          ...
          + assert (z0 ∈ (z ∪ [f[u]])). { apply Theorem4; tauto. }
            rewrite H17 in H19; apply Theorem4 in H19; destruct H19; auto.
            apply H16 in H18; unfold Difference in H18; apply Theorem4' in H18.
            destruct H18; unfold Complement in H20; apply Axiom_Scheme in H20.
            destruct H20; contradiction.
        - unfold Domain; apply Axiom_Extent; split; intros.
          + apply Axiom_Scheme in H13; destruct H13, H14.
          ...
          + apply Axiom_Scheme; split; Ens; exists (z ∪ [f[u]]).
            apply Axiom_SchemeP; repeat split; auto; apply Theorem49.
        ...
        - unfold Range; apply Axiom_Extent; split; intros.
          + apply Axiom_Scheme in H13; destruct H13, H14.
            ...
            * unfold Subclass; intros; apply Theorem4 in H17; destruct H17.
          ...
          + apply Axiom_Scheme in H13; destruct H13, H14; apply Axiom_Scheme.
            ...
            { apply Theorem33 with (x:= z); auto; unfold Subclass.
            ...
            * apply Axiom_Extent; split; intros.
              { generalize (classic (z0=f[u])); intros.
                ...
                - left; unfold Difference; apply Theorem4'; split; auto.
                  ...
                  apply Theorem19; Ens. }
              { apply Theorem4 in H17; destruct H17.
                - unfold Difference in H17; apply Theorem4' in H17; apply H17.
      ...
      apply Theorem33 with (x:= pow(y)); auto; unfold Subclass at 1; intros.
...
Proof.
  ...
  - assert (P[x] ⊂ P [x] /\ P[x] ≠ Φ). { split; unfold Subclass; Ens. }
      ...
      - rewrite H14; unfold Equivalent; exists (f | (x ~ [x0])).
        ...
        + apply Axiom_Extent; split; intros.
          ...
          * unfold Domain; apply Axiom_Scheme; split; Ens; exists f[z0]; double H15.
            unfold Difference in H16; apply Theorem4' in H16; destruct H16.
        ...
        + apply Axiom_Extent; split; intros.
          * unfold Range in H15; apply Axiom_Scheme in H15; destruct H15, H16.
            ...
            unfold Difference in H20; apply Theorem4' in H20; destruct H20.
          ...
          * unfold Range; apply Axiom_Scheme; split; Ens; assert (z0 ∈ ran(f)).
            ...
            split; try apply Theorem19; auto; unfold Difference.
        ...
        + apply Axiom_Extent; split; intros.
          * unfold Range in H15; apply Axiom_Scheme in H15; destruct H15, H16.
            ...
            { apply H18 in H19; clear H18; rewrite H19; double H11.
              ...
              apply Theorem49 in H20; destruct H20; apply Axiom_Scheme in H18.
            ...
            { double H19; apply H18 in H20; clear H18; double H20.
              ...
              apply Theorem4 in H20; destruct H20; auto; apply Axiom_Scheme in H15.
          ...
          * unfold Range; apply Axiom_Scheme; split; Ens.
            ...
            { exists x0; apply Property_dom in H5; apply Axiom_SchemeP.
              ...
              rewrite H7 in H5; unfold Difference; apply Theorem4'; split; auto.
              unfold Complement; apply Axiom_Scheme; split; Ens; intro.
              unfold Singleton in H19; apply Axiom_Scheme in H19; destruct H19.
    ...
    { split.
      - apply (Theorem33 x _); auto; unfold Subclass; intros.
        unfold Difference in H15; apply Theorem4' in H15; apply H15.
      - unfold Subclass, Difference; intros; apply Theorem4'; split; auto.
    ...
    assert (u ∈ C). { apply Theorem164; apply Axiom_Scheme; split; auto. }
    clear H5 H13; apply Theorem156 in H14; destruct H14; rewrite H13 in H15.
    assert (u ∈ (u ∪ [u])). { apply Theorem4; right; apply Axiom_Scheme; Ens. }
...
Proof.
  intros; unfold Difference; apply Theorem4'; split; auto.
  unfold Complement; apply Axiom_Scheme; split; Ens.
Qed.
...
Proof.
    ...
    - apply Axiom_Extent; split; intros.
      ...
      + unfold Domain; apply Axiom_Scheme; split; Ens.
        ...
        * exists (PlusOne z); apply Axiom_SchemeP; repeat split; intros; auto.
          ...
          { unfold Difference in H4; apply Theorem4' in H4; destruct H4.
            apply Axiom_Scheme in H5; destruct H5; contradiction. }
        * exists z; apply Axiom_SchemeP; repeat split; try apply Theorem49; Ens.
    ...
    - apply Axiom_Extent; split; intros.
      + unfold Range in H2; apply Axiom_Scheme in H2; destruct H2, H3.
        ...
        * double H6; apply H5 in H7; clear H5; double H6; double H6.
          ...
          clear H7; apply H1 in H6; unfold Difference; apply Theorem4'.
        ...
        * double H4; apply Lemma173 in H7; auto; apply H5 in H7; clear H5.
          rewrite H7 in *; clear H7; unfold Difference; apply Theorem4'.
          split; auto; unfold Complement; apply Axiom_Scheme; split; Ens.
      ...
      + unfold Difference in H2; apply Theorem4' in H2; destruct H2.
        ...
        * unfold W in H5; apply Axiom_Scheme in H5; destruct H5; double H6.
          ...
          apply Axiom_SchemeP; repeat split; intros; try apply Theorem49; Ens.
          -- apply H1; apply Axiom_Scheme; Ens.
          -- unfold Difference in H10; apply Theorem4' in H10; destruct H10.
  ...
  { unfold Equivalent; exists (f | (P[x] ~ [Φ])).
    ...
    - unfold Restriction, Inverse in H7; destruct H7; apply Axiom_SchemeP in H7.
      apply Axiom_SchemeP in H8; destruct H7, H8; apply Theorem4' in H9.
    ...
    - apply Axiom_Extent; split; intros.
      ...
      + unfold Domain; apply Axiom_Scheme; split; Ens; exists f[z].
        unfold Restriction; apply Theorem4'; double H7; unfold Difference in H8.
  ...
  - unfold Subclass; intros; unfold Range, Restriction in H2.
    apply Axiom_Scheme in H2; destruct H2, H7; apply Theorem4' in H7; destruct H7.
...
Proof.
  intros.
  unfold Difference in H; apply Theorem4' in H; destruct H.
  double H; apply Lemma123 in H1; AssE (PlusOne x).
  add (x⊂(PlusOne x)) H2; try (unfold Subclass; intros; apply Theorem4; tauto).
  apply Theorem158 in H2; apply Axiom_Scheme in H0; destruct H0.
    ...
    { unfold Equivalent; exists (\{\λ v w, (v∈x /\ w=f[v]) \/ (v=x /\ w=z)\}\).
      ...
      - apply Axiom_Extent; split; intros.
        ...
        + unfold Domain; apply Axiom_Scheme; split; Ens; unfold PlusOne in H12.
          ...
          * exists z; apply Axiom_SchemeP; split; try apply Theorem49; Ens.
  ...
  - destruct H.
    ...
    + generalize (classic ((En_u (∩ En_y y) y) = Φ)); intros; destruct H5.
      ...
      * assert ((En_u (∩ En_y y) y) ⊂ R /\ (En_u (∩ En_y y) y) ≠ Φ).
        ...
        apply Lemma121 in H6; clear H5; destruct H6; apply Axiom_Scheme in H5.
    ...
    + assert ((En_v (∩ En_y y) y) ⊂ R /\ (En_v (∩ En_y y) y) ≠ Φ).
      ...
      apply Lemma121 in H5; clear H4; destruct H5; apply Axiom_Scheme in H4.
...
Proof.
  ...
  - assert ((Max x y) ∈ R).
    { assert (Ordinal x /\ Ordinal y); auto; apply Theorem110 in H8.
      ...
      - unfold R; apply Axiom_Scheme; split; auto. }
    double H8; apply Lemma123 in H9; unfold R in H8, H9; apply Axiom_Scheme in H8.
    apply Axiom_Scheme in H9; destruct H8, H9; unfold LessEqual in H.
    assert ((Max x y) ∈ (PlusOne (Max x y))).
    { unfold PlusOne; apply Theorem4; right; apply Axiom_Scheme; split; auto. }
    ...
    + double H8; apply Property_Max in H9; auto; rewrite H9 in H; rewrite H8.
      clear H8 H9 H11; apply Axiom_SchemeP; repeat split; try apply Theorem49; auto.
  - rewrite <- H in *; clear H; assert (Ordinal u /\ Ordinal v); auto.
    ...
    + double H; apply Property_Max in H8; auto; rewrite H8; clear H8.
      unfold Cartesian; apply Axiom_SchemeP; repeat split; try apply Theorem49; Ens.
      * apply Theorem4; tauto.
      * apply Theorem4; right; apply Axiom_Scheme; auto.
    ...
    + double H; apply Property_Max in H8; rewrite H8; clear H8; rewrite H at 1.
      unfold Cartesian; apply Axiom_SchemeP; split; try apply Theorem49; auto.
      split; apply Theorem4; right; apply Axiom_Scheme; auto.
Qed.
...
Proof.
  ...
  - destruct H4; apply Axiom_SchemeP in H4; apply Axiom_SchemeP in H5.
    ...
    apply Axiom_SchemeP in H5; destruct H4, H5, H6, H7; apply Theorem49 in H4.
  ...
  - apply Axiom_Extent; split; intros.
    ...
    + apply Axiom_Scheme; split; Ens; PP H4 a b; exists [f[a],f[b]].
      ...
      apply Axiom_SchemeP; repeat split; try apply Theorem49; try split; auto.
      * apply Theorem49; Ens.
...
Proof.
  ...
  - apply Axiom_Extent; split; intros.
    ...
    + unfold Domain; apply Axiom_Scheme; split; Ens; exists [z,x0].
      apply Axiom_SchemeP; repeat split; auto; apply Theorem49; split; Ens.
      apply Theorem49; split; Ens.
  - apply Axiom_Extent; split; intros.
    + unfold Range in H0; apply Axiom_Scheme in H0; destruct H0, H1.
    ...
    + unfold Range; apply Axiom_Scheme; split; Ens; PP H0 a b.
      ...
      apply Axiom_SchemeP; repeat split; auto; try apply Theorem49; Ens.
...
Proof.
  ...
  - assert (\{ λ z, z ∈ (C ~ W) /\ P[z × z] <> z \} ⊂ C /\
    ...
    assert (x0 × x0 ⊂ R × R).
    { unfold Difference in H2; apply Theorem4' in H2; destruct H2 as [H2 _].
    ...
    { intros.
      ...
      { rewrite <- H6 in H9; apply Property_Value in H9; try apply H4.
        ...
        - apply Axiom_Extent; split; intros.
          ...
          + unfold Range; apply Axiom_Scheme; split; Ens; double H8; double H9.
            ...
            assert ([z,x1] ∈ f ⁻¹).
            { apply Axiom_SchemeP; split; auto; apply Theorem49.
      ...
      { clear H9; intros; clear H x.
        ...
        { unfold Subclass; intros; PP H a b; apply Axiom_SchemeP in H12.
          ...
          apply Axiom_SchemeP; split; auto; apply Theorem4' in H2; destruct H2.
          unfold C in H2; apply Axiom_Scheme in H2; destruct H2 as [_ H2].
          ...
          - destruct H17; apply Axiom_Scheme; split; Ens.
            apply (Theorem132 b _); auto; apply Axiom_Scheme in H14; apply H14.
          - rewrite H16 in H14; contradiction.
          - destruct H17; apply Axiom_Scheme; split; Ens.
            apply (Theorem132 a _); auto; apply Axiom_Scheme in H13; apply H13.
          - destruct H17; apply Axiom_Scheme; split; Ens.
            apply (Theorem132 b _); auto; apply Axiom_Scheme in H14; apply H14.
          - rewrite H16 in H14; contradiction.
      ...
      - double H9; rewrite <- H6 in H9.
        ...
        clear H x; unfold Difference in H2; apply Theorem4' in H2.
        ...
        + apply Property_Max in H20; auto; rewrite H20 in *.
          ...
          * assert (v ∈ (R ~ W)).
            { unfold Difference; apply Theorem4'; split; apply Axiom_Scheme; Ens. }
            ...
            { apply Property_PClass in H8.
              ...
              { apply Axiom_Scheme; repeat split; Ens.
                ...
                - assert (v ≼ (PlusOne v)); unfold LessEqual; auto.
                  ...
                  apply Lemma123 in H22; apply Axiom_Scheme in H22; apply H22. }
            ...
            { apply Property_PClass in H8.
              ...
              { apply Axiom_Scheme; repeat split; Ens.
                ...
                - assert (v ≼ (PlusOne v)); unfold LessEqual; auto.
                  ...
                  assert (v ∈ R). apply Axiom_Scheme; Ens.
                  apply Lemma123 in H20; apply Axiom_Scheme in H20; apply H20. }
              apply H1 in H12; destruct H12; unfold Rrelation, E.
              apply Axiom_SchemeP; split; try apply Theorem49; Ens.
              rewrite H18, <- H7; auto. }
    ...
    { assert (P[dom(f)] = P[ran(f)]).
      ...
      add (ran( f) ⊂ x0) H0; apply Theorem158 in H0; unfold Difference in H2.
    ...
    { unfold Difference in H2; apply Theorem4' in H2; destruct H2.
      ...
      - apply Lemma35 in H12; destruct H12 as [z H12].
        assert (P[x0] = P[x0 × [z]]).
...
Proof.
  ...
  - apply Axiom_Extent; split; intros.
    ...
    + apply Axiom_Scheme; split; Ens; PP H a b; exists [b,a].
      ...
      apply Axiom_Scheme; split; try apply Theorem49; Ens.
  - apply Axiom_Extent; split; intros.
    + apply Axiom_Scheme in H; destruct H, H0.
    ...
    + unfold Range; apply Axiom_Scheme; split; Ens; PP H a b.
      ...
      apply Theorem49 in H3; destruct H3; apply Axiom_SchemeP.
...
Proof.
  ...
  - assert (Ensemble (y × y) /\ (x × y) ⊂ (y × y)).
    ...
    apply Theorem158 in H10; apply Lemma35 in H2; destruct H2.
    assert (y ≈ ([x0] × y)).
    { apply Theorem147 with (y:= y × [x0]); try apply Lemma179'; Ens.
      apply Lemma180. }
    assert (Ensemble (x × y) /\ ([x0] × y) ⊂ (x × y)).
    { split; try apply Theorem74; Ens; unfold Subclass; intros.
...
Proof.
  ...
  assert ((C ~ W) ⊂ R).
  { unfold Subclass, Difference; intros; apply Theorem4' in H1; destruct H1.
...
Proof.
  ...
  assert ((C ~ W) ⊂ R).
  { unfold Subclass, Difference; intros; apply Theorem4' in H7; destruct H7.
  ...
  - apply Theorem27; split; auto; unfold Subclass; intros.
    ...
    double H9; rewrite <- Theorem70 in H9; auto; apply Axiom_SchemeP in H10.
...
Hint Resolve Theorem181 Theorem181' : set.
